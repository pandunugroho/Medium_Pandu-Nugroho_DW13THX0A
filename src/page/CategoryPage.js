        ...
        return (
            <div>
                ...
                <Grid container style={{width:"80%", marginLeft:"8%", backgroundColor:"tomato"}}>
                    <Grid md={8}><div style={{backgroundSize:"cover", height:"300px", width:"100%", backgroundImage:`url(${"https://miro.medium.com/max/4000/1*TBVJ41WGvXQMDZTLhl0RbA.jpeg"})`}}></div></Grid>
